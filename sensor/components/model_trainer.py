...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            logging.info("Train and test array divided into input and target variables")
            ...
            logging.info("Predicting y hat")

            classification_train_metric = get_classification_score(y_true = y_train,y_pred = y_train_pred)

            if classification_train_metric.f1_score <= self.model_trainer_config.expected_accuray:
            ...
            logging.info("Checking overfitting and underfitting")
            ...
            logging.info("Saving model and preprocessor object")
