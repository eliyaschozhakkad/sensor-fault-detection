...
class DataIngestionConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.train_test_split_ratio:float = training_pipeline.DATE_INGESTION_TRAIN_TEST_SPLIT_RATIO
...
class DataTransformationConfig:
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
        ...
        self.transformed_object_file_path:str = os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,training_pipeline.PREPROCESSING_OBJECT_FILE_NAME)
...
class ModelTrainerConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.trained_model_file_path:str = os.path.join(self.model_trainer_dir,training_pipeline.MODEL_TRAINER_TRAINED_MODEL_DIR,
                                                training_pipeline.MODEL_TRAINER_TRAINDED_MODEL_NAME)
        self.expected_accuray:float =  training_pipeline.MODEL_TRAINER_EXPECTED_SCORE
        self.overfitting_underfitting_threshold:float = training_pipeline.MODEL_OVERFITTING_UNDERFITTING_THRES
...
class ModelEvaluationConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.report_file_name:str = os.path.join(self.model_evaluation_dir,training_pipeline.MODEL_EVALUATION_REPORT_FILE_NAME)
...
class ModelPusherConfig:
    ...
    def __init__(self, training_pipeline_config = TrainingPipelineConfig):
        ...
        self.saved_model_path:str = os.path.join(training_pipeline.SAVED_MODEL_DIR,
                                                f"{timestamp}",training_pipeline.MODEL_FILE_NAME)
