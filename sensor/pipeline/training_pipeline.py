...
class TrainPipeline:
    ...
    def start_model_evaluation(self,data_valdation_artifact:DataValidationArtifact,model_trainer_artifact:ModelTrainerArtifact):
        
        try:
            logging.info("Starting model evaluation")
            model_eval_config = ModelEvaluationConfig(self.training_pipeline_config)
            model_eval = ModelEvaluation(model_eval_config = model_eval_config,
                                         data_validation_artifact = data_valdation_artifact, model_trainer_artifact = model_trainer_artifact)
    ...
    def start_model_pusher(self, model_eval_artifact:ModelEvaluationArtifact):
        ...
        try:
            ...
            logging.info("Model pusher is completed")
    ...
    def run_pipeline(self):
        ...
        try:
            ...
            model_trainer_artifact:DataTransformationArtifact = self.start_model_trainer(data_transformation_artifact = data_transformation_artifact)
            model_eval_artifact:ModelEvaluationArtifact = self.start_model_evaluation(data_valdation_artifact = data_validaiton_artifact, model_trainer_artifact = model_trainer_artifact)
